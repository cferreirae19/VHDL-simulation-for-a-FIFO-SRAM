...
HD_PWD='C:/Users/cferr/Desktop/Laboratorio CEP/P1/fifo_board_test/fifo_board_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_fifo_16_byte_disttributed_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_fifo_16_byte_disttributed_RAM.tcl
