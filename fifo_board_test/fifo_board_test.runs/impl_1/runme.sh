...
HD_PWD='C:/Users/cferr/Desktop/Laboratorio CEP/P1/fifo_board_test/fifo_board_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_fifo_16_byte_disttributed_RAM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_fifo_16_byte_disttributed_RAM.tcl -notrace
