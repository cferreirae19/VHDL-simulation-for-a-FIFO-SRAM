...
HD_PWD='C:/Users/cferr/Desktop/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_16_byte_distributed_RAM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fifo_16_byte_distributed_RAM.tcl -notrace
