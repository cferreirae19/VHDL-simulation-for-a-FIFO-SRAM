...
HD_PWD='C:/Users/cferr/Desktop/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_16_byte_distributed_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_16_byte_distributed_RAM.tcl
